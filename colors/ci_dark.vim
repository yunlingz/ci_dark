...
" ----------------------------------------------------
call s:HL('Statement', s:colors.magenta, s:colors.none)
call s:HL('Conditional', s:colors.cyan, s:colors.none)
call s:HL('Repeat', s:colors.cyan, s:colors.none)
call s:HL('Operator', s:colors.magenta, s:colors.none)
call s:HL('Keyword', s:colors.magenta, s:colors.none)
call s:HL('Exception', s:colors.cyan, s:colors.none)
" ----------------------------------------------------
...
" ----------------------------------------------------
call s:HL('Type', s:colors.yellow, s:colors.none)
call s:HL('StorageClass', s:colors.yellow, s:colors.none)
call s:HL('Structure', s:colors.magenta, s:colors.none)
call s:HL('Typedef', s:colors.yellow, s:colors.none)
" ----------------------------------------------------
